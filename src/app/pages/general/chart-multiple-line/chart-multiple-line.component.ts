...
@Component({
  selector: 'app-chart-multiple-line',
  templateUrl: './chart-multiple-line.component.html',
  styleUrls: ['./chart-multiple-line.component.scss'],
})
export class ChartMultipleLineComponent implements OnInit, AfterViewInit {
  @ViewChild('demo') demoDom: ElementRef;
  title: string = 'Multiple Line Chart Title';
  description: string = 'Description of Multiple Line Chart';
  data = [
    {
      name: 'China',
      year: '2000',
  ...
  ngAfterViewInit(): void {
    console.log(Line);
    const linePlot: Line = new Line(this.demoDom.nativeElement, {
      appendPadding: 10,
      // title: {
      //   visible: true,
      //   text: 'Title',
